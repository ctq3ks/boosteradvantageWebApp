      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7jaz")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Dividerxpd")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7zjd")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividertea")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7cef")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28dmw")}
          >
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, "Buttonhlb")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, "Buttonzfn")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, "Buttonamp")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, "Buttonecq")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28lsm")}
          >
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="L"
              {...getOverrideProps(overrides, "Buttonvko")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, "Buttonjdc")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="2XL"
              {...getOverrideProps(overrides, "Buttonkfs")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, "Buttonnel")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
