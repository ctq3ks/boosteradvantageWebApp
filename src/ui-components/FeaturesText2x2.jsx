        ...
        >
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 136qrr")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconnee")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorbhq")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.vke"
                )}
              ></Text>
            </Flex>
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 376glq")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconnpr")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorpsp")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.cpn"
                )}
              ></Text>
            </Flex>
          </Flex>
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 136kuz")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconalm")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorxol")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.dqt"
                )}
              ></Text>
            </Flex>
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Frame 376qok")}
            >
              <View
                width="40px"
                height="40px"
                ...
                position="relative"
                padding="0px 0px 0px 0px"
                {...getOverrideProps(overrides, "Iconqif")}
              >
                <Icon
                  width="30px"
                  height="30px"
                  ...
                  left="12.5%"
                  right="12.5%"
                  {...getOverrideProps(overrides, "Vectorenp")}
                ></Icon>
              </View>
              <Text
                fontFamily="Inter"
              ...
              <Text
                ...
                {...getOverrideProps(
                  overrides,
                  "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.ulg"
                )}
              ></Text>
            </Flex>
          </Flex>
