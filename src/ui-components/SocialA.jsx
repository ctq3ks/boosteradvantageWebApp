    ...
    >
        ...
        >
          ...
          >
            <MyIcon
              ...
              padding="0px 0px 0px 0px"
              type="arrow-right"
              {...getOverrideProps(overrides, "MyIconakt")}
            ></MyIcon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          >
            <Text
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Shareqsz")}
            ></Text>
            <MyIcon
              width="24px"
              height="24px"
              ...
              {...getOverrideProps(overrides, "MyIconxea")}
            ></MyIcon>
            <MyIcon
              width="24px"
              height="24px"
              ...
              padding="0px 0px 0px 0px"
              type="share"
              {...getOverrideProps(overrides, "MyIconsjp")}
            ></MyIcon>
            <MyIcon
              width="24px"
              height="24px"
              ...
              padding="0px 0px 0px 0px"
              type="more_vert"
              {...getOverrideProps(overrides, "MyIconnvm")}
            ></MyIcon>
          </Flex>
        </Flex>
        <Image
      ...
      >
        <MyIcon
          ...
          padding="0px 0px 0px 0px"
          type="arrow-right"
          {...getOverrideProps(overrides, "MyIconoiw")}
        ></MyIcon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read morejst")}
        ></Text>
      </Flex>
    </Flex>
  );
